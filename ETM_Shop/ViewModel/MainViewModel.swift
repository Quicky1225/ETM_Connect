...
//  ETM_Shop
//
//  Created by Дмитрий Шеин on 27.02.2024.
//
...
//        #endif
    ...
    //MARK: ServiceCall
        func serviceCallLogin(){
            ...
            if(!txtEmail.isValidEmail) {
                self.errorMessage = "Пожалуйста, введите почту"
                self.showError = true 
                return
            }
            
            if(txtPassword.isEmpty) {
                self.errorMessage = "Пожалуйста, введите пароль"
                self.showError = true
                return
            }
    ...
    func serviceCallSignUp(){
        ...
        if(txtUsername.isEmpty) {
            self.errorMessage = "Пожалуйста, введите имя пользователя"
            self.showError = true
            return
        }
